...
Gomoku::Gomoku()
    : boardIndex(15),
      ...
      maxVisibleMessages((chatLogHeight - 30) / 20),
      currentPlayer(Player::Player1),
      player1Name("Player 1"),
      player2Name("Player 2"),
      
      window(sf::VideoMode(830, 540), "np_FP_Gomoku"),
      turnCount(1) {
    if (!loadTextures()) {
